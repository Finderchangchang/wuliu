package vikicc.custom.spinner.nicespinner;
...
public class NiceSpinner extends TextView {
    ...
    public void onRestoreInstanceState(Parcelable savedState) {
        if (savedState instanceof Bundle) {
            ...
            if (mAdapter != null) {
                setText("上传检测间隔时间:" +mAdapter.getItemInDataset(mSelectedIndex).toString());
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                setText("上传检测间隔时间:" + mAdapter.getItemInDataset(position).toString());
                dismissDropDown();
            }
        });
    ...
    private void setAdapterInternal(@NonNull NiceSpinnerBaseAdapter adapter) {
        ...
        setText("上传检测间隔时间:" +adapter.getItemInDataset(mSelectedIndex).toString());
    }
